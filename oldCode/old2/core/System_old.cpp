...
void System_old::printKernelInfo() {
}

void System_old::loadAllConfig() {
    // load for the System
...
void System_old::printSystemInfo() {
    printKernelInfo();
    for (const auto& driver : drivers) {
        driver->printInfo();
    }
...
void System_old::printHelp(const OString& param) {
...
void System_old::printTimeStat() {
}

void System_old::treatCommands() {
